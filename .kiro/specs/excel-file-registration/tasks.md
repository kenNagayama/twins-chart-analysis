...
- [ ] 2. アップロードファイル読み込み用のキャッシュ関数を実装する
...
- [ ] 3. エラーハンドリングとユーザーフィードバック表示を実装する
- [ ] 3.1 ファイル未選択時のガード処理を実装する
...
- [ ] 3.2 LoadError の種別に応じたエラーメッセージ表示を実装する
...
- [ ] 4. データソース切り替えとパイプライン統合を実装する
- [ ] 4.1 選択されたデータソースに応じたデータ取得ロジックを実装する
